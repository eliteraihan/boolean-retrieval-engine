...
def shunting_yard(infix_tokens):
    ...
    # print ('postfix notation string: ', output)  # check
    return output
...
with open (queries_file, "w") as queue:
    print('Mau Cari Apa Gan?')
    print('* contoh: polisi AND maling AND pelaku OR pasar OR (NOT kepala) AND (pelayan OR penjahat)')
    print('* operator Boolean yang digunakan: \'AND\', \'OR\', \'NOT\', \'(\', dan \')\'.\n')
    queue.write (input ());
